...
#define PBS_PROC_SID(x)  proc_tbl[x].pi_sid
#define PBS_PROC_PID(x)  proc_tbl[x].pi_pid
#define PBS_PROC_PPID(x) proc_tbl[x].pi_ppid
...
extern int	aixlargepage;		/* config option for large page mode */
